public class Odontologo {
    ...
    public Odontologo(String nombre, String apellido, String especialidad, int sedeMain) {
        this.nombre = nombre;
        this.apellido = apellido;
        this.especialidad = especialidad;
        this.sedeMain = sedeMain;
    ...
    public int getSedeMain() { return sedeMain; }
    public void setSedeMain(int sedeMain) { this.sedeMain = sedeMain; }
